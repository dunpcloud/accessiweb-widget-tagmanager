...

{
  ...
  "description": "Il widget AccessiWeb aggiunge al tuo sito web strumenti, regolazioni ed impostazioni di accessibilità progettate per personalizzare l\u0027esperienza di navigazione e fruizione dei contenuti",
  "containerContexts": [
    "WEB"
  ]
}
